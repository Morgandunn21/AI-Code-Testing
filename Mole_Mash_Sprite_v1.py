...
class Mole:
    ...
    def draw(self):
        ...
        if self.is_mole_up:
            # Get the width and height of the mole sprite
            sprite_width, sprite_height = Mole_Sprite.get_size()
            ...
            # Draw the mole sprite on the screen
            screen.blit(Mole_Sprite, (sprite_x, sprite_y))
